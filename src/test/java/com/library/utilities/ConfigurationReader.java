...
public class ConfigurationReader {
    ...
    private ConfigurationReader(){ // not be able to create an obj
    ...
    public static String getProperty(String key){  // getter method for encapsulated property
        return properties.getProperty(key); // Map
    }
}
